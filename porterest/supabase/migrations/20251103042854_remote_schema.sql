...
GRANT ALL ON SEQUENCE "public"."auth_identities_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."auth_identities_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."auth_identities_id_seq" TO "service_role";
